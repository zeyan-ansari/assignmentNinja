...
class PreviousEmplyeeCard extends StatefulWidget {
  const PreviousEmplyeeCard({
    super.key, required this.box,
  });
  final Box box;

  @override
  State<PreviousEmplyeeCard> createState() => _PreviousEmplyeeCardState();
}

class _PreviousEmplyeeCardState extends State<PreviousEmplyeeCard> {
  @override
                        ...
                        child: Container(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            ...
                            children: [
                              ...
                              Text(                              DateFormat.yMMMd().format(DateTime.parse(personData.endDate))
